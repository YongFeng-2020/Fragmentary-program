...
# 其中--video：到达输入视频文件的替代路线。如果该参数失效，那么脚本将会使用你的网络摄像头。
...
# approrpiate object, tracker constructors: 
else:
    ...
    # grab the appropiate object tracker using our dictionary of  OpenCV object tracker objects
...
# python opencv_object_tracker.py --video 20200827141143.mp4 --tracker kcf